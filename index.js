...
const displaySingle = `A total of ${totalRaised.toLocaleString("en-US", { style: "currency", currency: "USD" })} has been raised for ${fundedGamesCount} games. Currently ${unfundedGamesCount} 
game remains unfunded. We need your help to fund this amazing game!`;

const displayPlural = `A total of ${totalRaised.toLocaleString("en-US", { style: "currency", currency: "USD" })} has been raised for ${fundedGamesCount} games. Currently ${unfundedGamesCount} 
games remains unfunded. We need your help to fund these amazing games!`;

let descriptionString = unfundedGames === 1 ? displaySingle : displayPlural;
...
//for i in sorted games, console.log
